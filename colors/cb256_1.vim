...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
    ...
    call <SID>X("IncSearch", "0000ff", "ffffff", "")
    "LineNr
    call <SID>X("ModeMsg", "daa520", "", "")
    call <SID>X("MoreMsg", "2e8b57", "", "")
    call <SID>X("NonText", "addbe7", "000000", "bold")
    call <SID>X("Question", "00ff7f", "", "")
    "call <SID>X("Search", "ffffff", "c83232", "")
    "call <SID>X("Search", "87ceeb", "80ffff", "")
    call <SID>X("Search", "000000", "00afaf", "")
    call <SID>X("SpellBad", "ff0000", "0000ff", "reverse,underline")
    call <SID>X("SpellCap", "ffffff", "80afff", "")
    ...
    " completion
    hi Pmenu          gui=NONE   ctermfg=white ctermbg=darkblue
    hi PmenuSel       gui=BOLD   ctermfg=darkblue ctermbg=lightgray
    hi PmenuSbar      gui=BOLD   ctermfg=white ctermbg=darkblue cterm=bold
    hi PmenuThumb     gui=BOLD   ctermfg=white ctermbg=darkblue cterm=bold
